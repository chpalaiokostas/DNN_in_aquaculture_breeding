...
# Example of fitting a convolutional neural network (CNN)
model_cnn =keras.models.Sequential([
    keras.layers.Conv1D(16,6,activation="relu",input_shape=(X_train.shape[1],1)),
